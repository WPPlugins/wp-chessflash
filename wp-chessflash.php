 ...
 * Plugin URI: http://www.uvsnijmegen.nl/index.php/wp-chessflash/
 ...
 * Author URI: http://www.uvsnijmegen.nl/
 */
...
class chessflash
{
	...
	function parse($text)
	{
		...
		$ret3=chessflash::parse(substr($text,$matchblock['endblock']));
	...
	{	
		...
		//PvE: default colors from ChessFlash
		$ligth_def="f4f4ff";
		$dark_def="0072b9";
