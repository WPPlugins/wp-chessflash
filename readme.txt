...
= Why does the viewer skip plies when you play through the game with the arrow keys? =

This is a problem in older versions of Firefox (prior to 3.6.2) with the wmode=transparent option for flash objects.
